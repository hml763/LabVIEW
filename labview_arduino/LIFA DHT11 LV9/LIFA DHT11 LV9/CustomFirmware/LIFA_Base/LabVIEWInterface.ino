...
void processCommand(unsigned char command[])
{
	...
	*********************************************************************************/
		...
		*********************************************************************************/
			case 0xFE:
				switch(DHT11.read(command[2]))
				{
					case DHTLIB_OK:
						// All good.  Send info.
						Serial.write(DHT11.humidity & 0xFF);
						Serial.write(DHT11.temperature & 0xFF);
						break;
					default: // DHTLIB_ERROR_CHECKSUM, DHTLIB_ERROR_TIMEOUT and everything else.
						// Send Error.
						Serial.write(0xFF);
						Serial.write(0xFF);
						break;
